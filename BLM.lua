...
state.OffenseMode:options('TP','ACC','DT','Refresh','PDT','MEVA')
...
function get_sets()
    ...
    back={ name="Taranus's Cape", augments={'MP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10','Mag. Evasion+15',}},
w    }

	-- 'TP','ACC','DT','Refresh','PDT','MEVA'
	sets.Idle.TP = set_combine(sets.Idle, {})
	sets.Idle.ACC = set_combine(sets.Idle, {})
	sets.Idle.DT = set_combine(sets.Idle, {})
	sets.Idle.Refresh = set_combine(sets.Idle, {
		head={ name="Merlinic Hood", augments={'Weapon skill damage +1%','Pet: Attack+13 Pet: Rng.Atk.+13','"Refresh"+2','Accuracy+13 Attack+13','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
	    hands={ name="Merlinic Dastanas", augments={'MND+1','Pet: Attack+16 Pet: Rng.Atk.+16','"Refresh"+1',}},
		legs="Assid. Pants +1",
		feet={ name="Merlinic Crackows", augments={'MND+9','AGI+6','"Refresh"+2','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
	})
...
function midcast_custom(spell)
	local equipSet = {}
	if spell.skill == 'Elemental Magic' and not Elemental_Enfeeble:contains(spell.name) and player.MPP < 40 then
		windower.add_to_chat(8,'Player Less than 40% MP - Recover MP!')
