...
state.WeaponMode:options('Annihilator','Naegling')
state.WeaponMode:set('Annihilator')
...
function get_sets()
	...
	Ammo.Bullet.RA = "Eradicating Bullet"	-- TP Ammo
	Ammo.Bullet.ACC = "Eradicating Bullet"	-- Accuracy Ammo
	Ammo.Bullet.CRIT = "Eradicating Bullet"	-- Critical Hit Mode Ammo
	Ammo.Bullet.WS = "Eradicating Bullet"	-- Physical Weaponskills (consumed)
	Ammo.Bullet.WSD = "Eradicating Bullet"	-- Physical Weaponskills (not consumed)
	Ammo.Bullet.MAB = "Eradicating Bullet"	-- Magical Weaponskills
	Ammo.Bullet.MACC = "Eradicating Bullet"	-- Magic Accuracy
	Ammo.Bullet.MAG_WS = "Eradicating Bullet"	-- Magic Weaponskills (Not Consumed)
	Ammo.Bullet.PHY_WS = "Eradicating Bullet"	-- Magic Weaponskills (Not Consumed)
	...
	sets.Idle = {
		...
		right_ring={ name="Dark Ring", augments={'Phys. dmg. taken -5%',}},
		back="Shadow Mantle",
    }
	...
	sets.OffenseMode.TP = {
		...
		back={ name="Belenus's Cape", augments={'STR+20','Accuracy+20 Attack+20','STR+9','Weapon skill damage +10%',}},
	}
 ...
 -- Need to upgrade Cape with 10% FC
	...
	sets.WS = {
		...
		left_ring="Rajas Ring",
		right_ring="Karieyh Ring",
		back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Weapon skill damage +10%',}}, -- Add Melee Cape
	}
