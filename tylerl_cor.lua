...
state.WeaponMode:options('Fomalhaut','Death Penalty', 'Savage Blade', 'Leaden Salute', 'Aeolian Edge', 'Evisceration')
...
function get_sets()
    ...
    sets.Midcast.RA = set_combine(sets.Midcast, {
		...
		back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','"Store TP"+10',}}, --replace
})
	...
	sets.PhantomRoll = {
		...
		hands="Chasseur's Gants +3", -- 45 sec Duration
	...
	sets.WS.RA = {
		...
		waist="Light Belt",
		left_ear={ name="Moonshade Earring", augments={'Rng.Atk.+4','TP Bonus +250',}},
		right_ear={ name="Amini Earring", augments={'System: 1 ID: 1676 Val: 0','Accuracy+7','Mag. Acc.+7',}}, -- Add COR ear
		left_ring="Rajas Ring",
		right_ring="Karieyh Ring",
		back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Weapon skill damage +10%',}}, -- Add COR back
}
